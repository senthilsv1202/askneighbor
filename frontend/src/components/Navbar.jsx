...
import { Search, Plus, Heart, LogOut, Users, ChevronDown, MapPin, PlusCircle, Home as HomeIcon, CalendarDays } from 'lucide-react';
        ...
        <div className="flex items-center gap-2">
          {user ? (
            <>
              ...
              <Link to="/events" title="Community events" className="p-2 text-slate-500 hover:text-primary-600 transition-colors">
